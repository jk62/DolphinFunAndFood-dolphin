...
export default function Home() {
  ...
  // hero/gallery-3 slideshow state
  ...
  // auto-advance gallery-3 (hero background)
  useEffect(() => {
  ...
  return (
    <main className="min-h-screen bg-sky-50 text-slate-900">
      ...
      <section className="relative overflow-hidden min-h-[60vh] md:min-h-[70vh] bg-gradient-to-b from-sky-100 via-sky-50 to-sky-100">
        {/* faint blurred version of the current photo behind everything */}
        <div className="absolute inset-0 -z-10 opacity-40">
          <Image
            key={g3Current.src + "-bg"}
            src={g3Current.src}
            alt=""
            fill
            sizes="100vw"
        ...
        {/* centered backdrop panel + slideshow image */}
      ...
      <section className="w-full bg-sky-50">
        ...
        {/* 2️⃣ gallery-2 tile slideshow, 2 rows of 5, edge-to-edge */}
...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! //
// Code below with inline reels inside hero section
// // src/app/page.tsx
// "use client";
...
//         const res = await fetch("/api/media", { cache: "no-store" });
//         const json = await res.json();
//         console.log("DEBUG /api/media", json); // 👈 add this
//         if (!cancel) {
//           setGallery(Array.isArray(json.gallery) ? json.gallery : []);
//           setReels1(Array.isArray(json.reels1) ? json.reels1 : []);
//           setReels2(Array.isArray(json.reels2) ? json.reels2 : []);
...
//         />
//         {/* Slight dark overlay over the whole hero */}
//         <div className="absolute inset-0 z-0 bg-black/10" />
//         CONTENT LAYER
//         <div className="relative z-10">
//           {/* 🧾 FULL-WIDTH GREY BAND FOR TITLE */}
...
//               {/* tagline + Open Now in one row */}
//               {/* tagline + Open Now in one row */}
//               <div className="mt-1 flex flex-wrap items-center justify-center gap-2 text-sm md:text-base text-sky-100">
//                 <p className="m-0">
//                   Murthal&rsquo;s New Destination for Food, Fun &amp; Family
//                   Moments!
//                 </p>

//                 <span
//                   className="ml-2 inline-flex items-center rounded-full bg-emerald-500/95 px-4 py-1.5
//                text-xs md:text-sm font-semibold text-white shadow-md animate-pulse"
//                 >
//                   <span className="relative flex h-2.5 w-2.5 mr-2">
//                     <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-white opacity-75" />
...
//             <div className="inline-block rounded-2xl bg-black/40 px-4 py-3 text-center backdrop-blur-sm">
//               <h1 className="text-3xl md:text-4xl font-bold">
//                 Dolphin Fun &amp; Food
//               </h1>
//               <p className="text-slate-200">
